        ...
        <Grid className="main-footer" >
            ...
            <Grid.Column className="footer-right" >
                <Grid.Row className="footer-colc-rowa" >
                    <Icon name="instagram" /> Siga-me no <a target="_blank" href={urlsFooters[3]} >Instagram</a>
                </Grid.Row>
                <Grid.Row className="footer-colc-rowb" >
                    <Icon name="twitter" /> Siga-me no <a target="_blank" href={urlsFooters[4]} >Twitter</a>
                </Grid.Row>
                <Grid.Row className="footer-colc-rowc" >
                    <Icon name="slack" /> Conheça meu canal publico no <a target="_blank" href={urlsFooters[4]} >Slack</a>
                </Grid.Row>
                <Grid.Row className="footer-cola-rowd" >
